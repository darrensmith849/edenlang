...
export function ContactHero() {
  return (
    <section className="relative pt-36 pb-16 md:pt-44 md:pb-20 bg-eden-black overflow-hidden">
      <div className="absolute top-20 left-1/2 w-[400px] h-[400px] rounded-full bg-eden-gold/3 blur-[120px] pointer-events-none" />
      <div className="relative z-10 mx-auto max-w-4xl px-6 md:px-8">
        ...
        <motion.p initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.2 }} className="text-eden-muted text-sm md:text-base leading-relaxed max-w-lg">
          For custom songs, guitar work, production, collaborations, worship bookings, or partnerships.
        </motion.p>
      </div>
    </section>
  );
