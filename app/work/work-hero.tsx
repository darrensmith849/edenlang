    ...
    <section className="relative pt-40 pb-24 md:pt-48 md:pb-32 bg-eden-black overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 md:px-8">
        ...
        >
          Music for stories.
          <br />
          <span className="text-eden-gold">Content with substance.</span>
        </motion.h1>
        ...
        >
          From original composition to artist production to brand content —
          creative work built on emotion, precision, and a deep understanding
          of what music can do for a story.
        </motion.p>
      </div>
    </section>
  );
